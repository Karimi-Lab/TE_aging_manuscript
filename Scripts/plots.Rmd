...
```{r,echo=F, eval=T, cache=F, message=F, warning=FALSE}
class_probes <- read_excel("../Results/missing_genes_230616.xlsx", sheet = "Class Probes")
...
family_probes <- read_excel("../Results/missing_genes_230616.xlsx", sheet = "Family Probes")
